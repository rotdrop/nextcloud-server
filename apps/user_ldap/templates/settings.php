...
?>
	...
	<fieldset id="ldapSettings-2">
		...
		<p><strong><?php p($l->t('Force Internal Username'));?></strong></p>
		<p class="ldapIndent"><?php p($l->t('Dangerous. Stick to the internal username even in case of conflicts. This will sort of transfer an existing user to the LDAP user backend. Changes will have effect only on newly mapped (added) LDAP users. Leave it empty for default behavior.'));?></p>
		<p class="ldapIndent"><label for="ldap_expert_username_force"><?php p($l->t('Force Internal Username:'));?></label><input type="checkbox" id="ldap_expert_username_force" name="ldap_expert_username_force" data-default="<?php p($_['ldap_expert_username_force_default']); ?>" value="1" /></p>
		<p><strong><?php p($l->t('Force Internal Groupname'));?></strong></p>
		<p class="ldapIndent"><?php p($l->t('Dangerous. Stick to the internal groupname even in case of conflicts. This will sort of transfer an existing group to the LDAP group backend. Changes will have effect only on newly mapped (added) LDAP groups. Leave it empty for default behavior.'));?></p>
		<p class="ldapIndent"><label for="ldap_expert_groupname_force"><?php p($l->t('Force Internal Groupname:'));?></label><input type="checkbox" id="ldap_expert_groupname_force" name="ldap_expert_groupname_force" data-default="<?php p($_['ldap_expert_groupname_force_default']); ?>" value="1" /></p>
