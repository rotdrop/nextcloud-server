import{c as u}from"./TrashCanOutline-CuVfryni.chunk.mjs";import{g as y,e as c,c as h}from"./public-D19CZ6Gw.chunk.mjs";import{t as o}from"./index-MtOXSqaQ.chunk.mjs";import{c as f}from"./index-BsMsvTBr.chunk.mjs";import{g as b}from"./dav-D1aqwqxI.chunk.mjs";const r=y().setApp("systemtags").detectUser().build(),O={userVisible:!0,userAssignable:!0,canAssign:!0},x=Object.freeze({"display-name":"displayName","user-visible":"userVisible","user-assignable":"userAssignable","can-assign":"canAssign"});function p(t){return t.map(({props:s})=>Object.fromEntries(Object.entries(s).map(([e,a])=>(e=x[e]??e,a=e==="displayName"?String(a):a,[e,a]))))}function w(t){const s=t.indexOf("?");s>0&&(t=t.substring(0,s));const e=t.split("/");let a;do a=e[e.length-1],e.pop();while(!a&&e.length>0);return Number(a)}function v(t){if("name"in t&&!("displayName"in t))return{...t};const s={...t};return s.name=s.displayName,delete s.displayName,s}function V(t){const s=t.attributes?.["system-tags"]?.["system-tag"];return s===void 0?[]:[s].flat().map(e=>typeof e=="string"?e:e.text)}function N(t,s){t.attributes["system-tags"]={"system-tag":s},c("files:node:updated",t)}const n=b(),l=`<?xml version="1.0"?>
<d:propfind xmlns:d="DAV:" xmlns:oc="http://owncloud.org/ns" xmlns:nc="http://nextcloud.org/ns">
	...
	</d:propfind>`,details:!0}),i=a?.data?.props?.getetag||'""',d=Object.values(a?.data?.props?.["object-ids"]||[]).flat();return{etag:i,objects:d}}async function q(t,s,e,a=""){const i=`/systemtags/${t.id}/${s}`;let d=`<?xml version="1.0"?>
	<d:propertyupdate xmlns:d="DAV:" xmlns:nc="http://nextcloud.org/ns">
		...
		</d:propertyupdate>`),await n.customRequest(i,{method:"PROPPATCH",data:d,headers:{"if-match":a}})}async function k(t){const s=t?"1":"0",e=h("/apps/provisioning_api/api/v1/config/apps/{appId}/{key}",{appId:"systemtags",key:"restrict_creation_to_admin"});await f();const{data:a}=await u.post(e,{value:s});return a}export{T as a,k as b,C as c,O as d,V as e,P as f,_ as g,N as h,D as i,r as l,q as s,R as u};
//# sourceMappingURL=api-dy7z9h70.chunk.mjs.map
